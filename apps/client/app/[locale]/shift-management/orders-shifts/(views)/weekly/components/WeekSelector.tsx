...
const WeekSelector = ({ currentDate, onDateChange }: WeekSelectorProps) => {
  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center space-x-2 text-[30px] font-bold text-center min-w-[300px] hover:bg-gray-50 rounded px-2 py-1">
          <span>
