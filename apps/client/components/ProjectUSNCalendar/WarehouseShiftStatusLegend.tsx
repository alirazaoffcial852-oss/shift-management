...
const WarehouseShiftStatusLegend = () => {
  ...
  return (
    <>
      <div className="hidden xl:flex items-center flex-wrap gap-3">
        <LegendItems />
      </div>
...
export default WarehouseShiftStatusLegend;
