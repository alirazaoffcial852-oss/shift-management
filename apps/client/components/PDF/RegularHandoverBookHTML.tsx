...
interface RegularHandoverBookHTMLProps {
  data?: RegularHandoverBookData;
  locale?: string;
}

const RegularHandoverBookHTML: React.FC<RegularHandoverBookHTMLProps> = ({
  data,
  locale = "en",
}) => {
  ...
  const startOfShiftChecks =
    data?.handoverbook_checks?.filter(
            ...
            <thead>
              ...
              <tr style={{ backgroundColor: "#f0f0f0" }}>
                ...
                >
                  ...
                  >
                    {t(
                      "checkCoolantLevelLubricantHydrostaticsGearboxEngineOil"
                    )}
                  </span>
                </th>
                <th
            ...
            <tbody>
              <tr>
                ...
                >
                  ...
                  >
                    {getValue(
                      data.handoverbook_coolant_oil_values.coolant_percent
                    )}
                  </span>
                </td>
                <td
...
export default RegularHandoverBookHTML;
