...
interface RegularHandoverBookPDFProps {
...
const RegularHandoverBookPDF: React.FC<RegularHandoverBookPDFProps> = ({
  data,
}) => {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <Text style={styles.title}>{t("regularShiftHandoverBook")}</Text>
        ...
        {data?.handoverbook_coolant_oil_values && (
          <View style={styles.section}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getValue(data.handoverbook_coolant_oil_values.coolant_percent)}
              </Text>
            </View>
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getValue(
                  data.handoverbook_coolant_oil_values.lubricant_percent
                )}
              </Text>
            </View>
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getValue(
                  data.handoverbook_coolant_oil_values.hydraulics_percent
                )}
              </Text>
            </View>
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getValue(
                  data.handoverbook_coolant_oil_values.transmission_oil_percent
                )}
              </Text>
            </View>
            <View style={styles.row}>
              ...
              <Text style={styles.value}>
                {getValue(
                  data.handoverbook_coolant_oil_values.engine_oil_percent
                )}
              </Text>
            </View>
          </View>
        ...
        {data?.handoverbook_checks && data.handoverbook_checks.length > 0 && (
          <View style={styles.section}>
            ...
            <View style={styles.table}>
              ...
              {data.handoverbook_checks.map((check, index) => (
        ...
        {data?.shift && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>{t("shiftInformation")}</Text>
            <View style={styles.row}>
              <Text style={styles.label}>{t("shiftDate")}</Text>
              <Text style={styles.value}>{formatDate(data.shift.date)}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>{t("startTime")}</Text>
              <Text style={styles.value}>
                {formatDateTime(data.shift.start_time)}
              </Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.label}>{t("endTime")}</Text>
              <Text style={styles.value}>
                {formatDateTime(data.shift.end_time)}
              </Text>
            </View>
          </View>
        )}
...
export default RegularHandoverBookPDF;
