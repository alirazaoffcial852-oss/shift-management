...
export default function EmployeesFeedbacks() {
        ...
        if (shiftType === "regular") {
          ...
          const transformedData = shifts.map((shift: any) => {
            ...
            const trainDriverName =
              ...
              "";
            const shantingAttendantName =
              shantingAttendantRole?.shiftPersonnel?.[0]?.employee?.name ||
              shantingAttendantRole?.employee?.name ||
              "";

            // Combine employee names for the Employee column
            const employeeNames = [trainDriverName, shantingAttendantName]
            ...
            return {
              ...
              shantingAttendant: shantingAttendantName || "-",
            };
          });
  ...
  const columns: TableColumn[] = [
    ...
    { header: "Employee", accessor: "employee", className: "w-[160px]" },
